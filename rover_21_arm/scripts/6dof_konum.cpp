...
coordinate Dof_6(double t0, double t1, double t2, double t3, double t4){
	...
	double px = L4*(cos(t0)*cos(t1)*sin(t2) + cos(t0)*cos(t2)*sin(t1)) - L5*(cos(t4)*(sin(t0)*sin(t3) + cos(t3)*(cos(t0)*sin(t1)*sin(t2) - cos(t0)*cos(t1)*cos(t2))) - sin(t4)*(cos(t0)*cos(t1)*sin(t2) + cos(t0)*cos(t2)*sin(t1))) - L2*cos(t0)*sin(t1) + L3*cos(t0)*cos(t1)*cos(t2) - L3*cos(t0)*sin(t1)*sin(t2);
    double py = L5*(cos(t4)*(cos(t0)*sin(t3) - cos(t3)*(sin(t0)*sin(t1)*sin(t2) - cos(t1)*cos(t2)*sin(t0))) + sin(t4)*(cos(t1)*sin(t0)*sin(t2) + cos(t2)*sin(t0)*sin(t1))) + L4*(cos(t1)*sin(t0)*sin(t2) + cos(t2)*sin(t0)*sin(t1)) - L2*sin(t0)*sin(t1) + L3*cos(t1)*cos(t2)*sin(t0) - L3*sin(t0)*sin(t1)*sin(t2);
    double pz = L1 - L4*(cos(t1)*cos(t2) - sin(t1)*sin(t2)) + L2*cos(t1) - L5*(sin(t4)*(cos(t1)*cos(t2) - sin(t1)*sin(t2)) - cos(t3)*cos(t4)*(cos(t1)*sin(t2) + cos(t2)*sin(t1))) + L3*cos(t1)*sin(t2) + L3*cos(t2)*sin(t1);
