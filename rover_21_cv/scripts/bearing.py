...
pxCoordinateTopic1 = rospy.get_param('RoverReachImage/calculatedBearing/sub_pxCoordinates1', '/px_coordinates1')
...
def calculateBearing(pxWidth, pxHeight,pxWidth1, pxHeight1, videoWidth, videoHeight):
    ...
    if(sc_sub >= 4):
        if pxWidth != None and videoWidth != None and pxWidth1 != None and noArtag == False :
            center = videoWidth / 2
            anglePerPixel = camAngleOfView/videoWidth
...
def printIt(pxWidth,pxHeight,videoWidth,videoHeight):    
    print("pxWidth : "+ str(pxWidth) + " pxHeight : " + str(pxHeight) + "pxWidth1 : "+ str(pxWidth1) + " pxHeight1 : " + str(pxHeight1) + " videoWidth : " + str(videoWidth) + " videoHeight : " + str(videoHeight))
...
def main():
    ...
    while not rospy.is_shutdown():
        calculateBearing(pxCoordinates[0],pxCoordinates[1], pxCoordinates1[0],pxCoordinates1[1], videoWidth,videoHeight)
